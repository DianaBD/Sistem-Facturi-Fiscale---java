...
public class Gestiune {
	...
	private Gestiune() throws IOException{
		
		//--------citire fisier "produse.txt"---------
		
		RandomAccessFile f = new RandomAccessFile("produse.txt","r");
		...
		f = new RandomAccessFile("taxe.txt","r");
		...
		f = new RandomAccessFile("facturi.txt","r");
		line = f.readLine();
	...
	public static Gestiune getInstanceGestiune(){
		try{
		if(instance==null)
